...
import naveen.kadali.projektify.adapters.BoardItemsAdapter
import naveen.kadali.projektify.firebase.FirestoreClass
import naveen.kadali.projektify.model.Board
...
class MainActivity : BaseActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    override fun onNavigationItemSelected(menuItem: MenuItem): Boolean {
        when (menuItem.itemId) {
            ...
            R.id.app_about -> {
                startActivity(Intent(this@MainActivity, AppAboutSection::class.java))
            }
        }
        drawer_layout.closeDrawer(GravityCompat.START)
        return true
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        } else if (requestCode == DELETE_BOARD_REQUEST_CODE
        ) {
            FirestoreClass().getBoardsList(this@MainActivity)
        } else {
    ...
    fun deleteBoardMainActivity(board: Board) {
        FirestoreClass().removeBoard(this@MainActivity, board)
    }

    fun boardDeletedSuccessfully() {
        setResult(Activity.RESULT_OK)
        MainActivity().updateBoardListAfterDeletingABoard()
    }

    fun updateBoardListAfterDeletingABoard() {
        FirestoreClass().getBoardsList(this@MainActivity)
    }
