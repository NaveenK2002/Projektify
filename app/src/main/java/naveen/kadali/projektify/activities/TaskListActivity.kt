...
import naveen.kadali.projektify.adapters.TaskListItemsAdapter
import naveen.kadali.projektify.firebase.FirestoreClass
import naveen.kadali.projektify.model.Board
import naveen.kadali.projektify.model.Card
import naveen.kadali.projektify.model.Task
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.delete_board -> {
                ...
                MainActivity().deleteBoardMainActivity(mBoardDetails)
            }
        }
