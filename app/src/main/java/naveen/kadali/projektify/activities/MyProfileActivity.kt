...
class MyProfileActivity : BaseActivity() {
    ...
    private lateinit var mUserDetailes: User
    ...
    override fun onRequestPermissionsResult(
        ...
        if(requestCode == READ_STORAGE_PERMISSION_CODE){
            ...
            Toast.makeText(this,
                "Storage permission denied! You can allow it from settings for using this functionality.",
    ...
    private fun updateUserProfileData(){
        ...
        if(mProfileImageURL.isNotEmpty() && mProfileImageURL != mUserDetailes.image){
            userHashMap[Constants.IMAGE] = mProfileImageURL
        }
        if(et_name.text.toString() != mUserDetailes.name){
            userHashMap[Constants.NAME] = et_name.text.toString()
        }
        if (et_mobile.text.toString() != mUserDetailes.mobile.toString()){
