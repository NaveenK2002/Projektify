    ...
    private fun updateUserProfileData() {
        try {
            if(et_mobile.text.toString().length!=10) {
                throw NumberFormatException("Mobile number should be of 10 digits!")
            }
            ...
            Toast.makeText(this, "Number cannot be empty, and should be of 10 digits only, details not updated!", Toast.LENGTH_LONG).show()
            hideProgressDialog()
        }
    }
